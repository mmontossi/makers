=== NOTE: From version 0.0.2 and above the syntax has been simplified.
...
There is no need to configure anything, all this is done automagically:
...
Define them inside test/fabricators/**/*.rb or spec/fabricators/**/*.rb:
  fabricator :user do
    name 'example'
  end
...
Define them outside your fabricators reference them by name:
