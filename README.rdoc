...
Generates an unique sequence of numbers for the attribute of that fabricator:
  fabricator :user do
...
Associations are declare just by the name of the association:
  fabricator :user do
    posts
